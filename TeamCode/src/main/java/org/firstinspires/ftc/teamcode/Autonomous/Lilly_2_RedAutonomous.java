...
@Autonomous(name="Lilly_2_RedAutonomous", group="ChampBot")

public class Lilly_2_RedAutonomous extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderStrafe(.35,28, Direction.right,2.0);
